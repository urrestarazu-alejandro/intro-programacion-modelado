...
/**
 * Precompiled ejercicios.modelado.java-application-conventions script plugin.
 **/
public class EjerciciosModeladoJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_EjerciciosModeladoJavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("ejercicios.modelado.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_EjerciciosModeladoJavaApplicationConventions").asSubclass(BasicScript.class);
