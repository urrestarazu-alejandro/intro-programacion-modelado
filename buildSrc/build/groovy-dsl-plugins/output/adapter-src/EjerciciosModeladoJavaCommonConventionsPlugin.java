...
/**
 * Precompiled ejercicios.modelado.java-common-conventions script plugin.
 **/
public class EjerciciosModeladoJavaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_EjerciciosModeladoJavaCommonConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_EjerciciosModeladoJavaCommonConventions").asSubclass(BasicScript.class);
